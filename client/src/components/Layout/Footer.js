        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-4">
              <h2>Contact Us</h2>
              <p>
                <i className="bi bi-geo-alt" /> 52nd Rte Carmel, New York(NY),
                10512
              </p>
              <p>
                <i className="bi bi-telephone" /> Call us at 0213-3262036
              </p>
              <p>
                <i className="bi bi-envelope" /> Email: capturemart@gmail.com
              </p>
